...
module ts {
    export var Diagnostics = {
        ...
        Catch_clause_parameter_cannot_have_a_type_annotation: {
            ...
            key: "Catch clause parameter cannot have a type annotation."
        },
        ...
        for_of_statements_are_only_available_when_targeting_ECMAScript_6_or_higher: {
            code: 2482,
            category: DiagnosticCategory.Error,
            key: "'for...of' statements are only available when targeting ECMAScript 6 or higher."
        },
        ...
        for_of_statements_are_not_currently_supported: {
            code: 9003,
            category: DiagnosticCategory.Error,
            key: "'for...of' statements are not currently supported."
        },
    };
}